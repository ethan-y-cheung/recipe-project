...
4. **Create a recipe** by filling out the form with a title, ingredients, directions, tags, and an optional cover image.
...
| Recipe browsing page | In progress (currently uses mock data) |
| Recipe detail page | In progress (recipe data is hardcoded, comments fetch from backend) |
| Create recipe form | In progress (UI complete, not yet connected to backend) |
...
| Bookmark / save recipes | In progress (UI complete, not yet saved to backend) |
| AI cooking assistant | Complete |
| Admin moderation panel | In progress (fetches pending recipes, approve/reject in progress) |
